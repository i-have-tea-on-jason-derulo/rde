  ...
  (remove
   ...
   (list
    (feature-user-info
     ...
     #:user-name "chopi"
     #:full-name "Chopi Boggy"
     #:email "58littlemouseyboys@gmail.com"
     #:user-groups '("lp" "wheel")) ;; TODO confluence of features|groups

    (feature-gnupg
     #:gpg-primary-key "6FAE7539ACC9E8EFB5FD475515C1AEAC48F133F1")

    (feature-password-store)

    ;;FIXME pass | add 58lmb@gmail
    (feature-mail-settings
     #:mail-accounts
     (list
      (mail-account
       (id   'personal)
       (fqda "58littlemouseyboys@gmail.com")
       (type 'gmail))))
...
(define ixy-mapped-devices
  (list (mapped-device
         (source (uuid "4b7d578d-da68-4da3-97a9-bf393ddec87f"))
         (target "my-root")
